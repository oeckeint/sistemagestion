<div class="modal fade" id="agregarClienteModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/ControlClientes?accion=insertar" method="post" class="was-validated" onsubmit="return validacion()">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="cups">CUPS</label>
                        <input type="text" id="cups" class="form-control" name="cups">
                    </div>
                    <div class="form-group">
