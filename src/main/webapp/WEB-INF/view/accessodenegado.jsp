...
<div class="wrapper">
    <div class="box">
        <h1>403</h1>
        <p>Lo siento <security:authentication property="principal.username" />, no tienes los permisos para ir más allá de este punto.</p>
        <p><a href="${pageContext.request.contextPath}/">Por favor, da click aquí para regresar</a></p>
    </div>
</div>
