    ...
    <head>
        ...
        <c:if test="${ documento != null }">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-5">
                                <ul class="list-group list-group-flush text-right">
                                    ...
                                    <dt class="list-group-item px-1">D�as</dt>
                                </ul>
                            </div>
                            <div class="col-7">
                                <ul class="list-group list-group-flush">
                ...
                <!--Cuarto Rengl�n-->
                <hr>
                <h2 class="display-4">Energ�a Activa</h2>
                <hr>
                <div class="row justify-content-around">
                    <div class="list-group col-12 col-md-5 col-lg-4 p-2">
                ...
                <div class="row justify-content-around">
                    <div class="list-group col-12 col-md-5 col-lg-4 p-2">
                        <h3 class="list-group-item list-group-item-action active text-center h4">Impuesto El�ctrico</h3>
                        <div class="row">
                            <div class="col-5">
                                <ul class="list-group list-group-flush text-right">
                                    <dt class="list-group-item px-1">Importe</dt>
