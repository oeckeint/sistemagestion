...
public class DatosPmConsumo {
    private double consumo1, consumo2, consumo3, consumo4, consumo5, consumo6, suma;

    public DatosPmConsumo() {
    }

    public DatosPmConsumo(List<Double> datos) {
    ...
    public String toString() {
        return "DatosPmConsumo{" + "consumo1=" + consumo1 + ", consumo2=" + consumo2 + ", consumo3=" + consumo3 + ", consumo4=" + consumo4 + ", consumo5=" + consumo5 + ", consumo6=" + consumo6 + ", suma=" + suma + '}';
    }
