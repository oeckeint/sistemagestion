...
public class DatosRLecturaDesde {
    private double lectura1, lectura2, lectura3, lectura4, lectura5, lectura6;

    public DatosRLecturaDesde() {
    }

    public DatosRLecturaDesde(List<Double> datos) {
    ...
    public String toString() {
        return "DatosRLecturaDesde{" + "lectura1=" + lectura1 + ", lectura2=" + lectura2 + ", lectura3=" + lectura3 + ", lectura4=" + lectura4 + ", lectura5=" + lectura5 + ", lectura6=" + lectura6 + '}';
    }
