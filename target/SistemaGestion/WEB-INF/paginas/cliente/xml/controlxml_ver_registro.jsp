                ...
                <div class="row justify-content-around">
                    <div class="list-group col-12 col-md-5 col-lg-4 p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item px-1">${documento.cargos1.c1}</li>
                                    <li class="list-group-item px-1">${documento.cargos1.c2}</li>
                                    <li class="list-group-item px-1">${documento.cargos1.c3}</li>
                                    <li class="list-group-item px-1">${documento.cargos1.c4}</li>
                                    <li class="list-group-item px-1">${documento.cargos1.c5}</li>
                                    <li class="list-group-item px-1">${documento.cargos1.c6}</li>
                                    <li class="list-group-item px-1">${documento.cargoImporteTotal1.impTot}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="list-group col-12 col-md-5 col-lg-4 p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item px-1">${documento.cargos2.c1}</li>
                                    <li class="list-group-item px-1">${documento.cargos2.c2}</li>
                                    <li class="list-group-item px-1">${documento.cargos2.c3}</li>
                                    <li class="list-group-item px-1">${documento.cargos2.c4}</li>
                                    <li class="list-group-item px-1">${documento.cargos2.c5}</li>
                                    <li class="list-group-item px-1">${documento.cargos2.c6}</li>
                                    <li class="list-group-item px-1">${documento.cargoImporteTotal2.impTot}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
